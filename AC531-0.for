...
C
      ...
      vr = 0.38
!
      kf = E1f / (2.0d0 * (1.0d0 - v12f - 2.0d0 * v12f**2))
      kr = Er / (2.0d0 * (1.0d0 - vr - 2.0d0 * vr**2))
      kt = ((kf + Gr) * kr + (kf - kr) * Gr * Vf) / ((kf + Gr) - (kf - 
     & kr) * Vf)
      G12 = Gr * ((G12f + Gr) + (G12f - Gr) * Vf) / ((G12f + Gr) - (G12f
     & - Gr) * Vf)
      G13 = G12
      G23 = Gr * (kr * (Gr + G23f) + 2.0d0 * G23f *Gr + kr *(G23f - Gr)* 
     & Vf) / (kr * (Gr + G23f) + 2.0d0* G23f* Gr -(kr + 2.0d0*Gr)*(G23f-
     & Gr) * Vf)
      v12 = v12f*Vf + vr * (1.0d0 - Vf) + ((vr - v12f) * (kr - kf) * Gr* 
     & (1.0d0 - Vf) * Vf) / ((kf + Gr) * kr + (kf - kr) * Gr * Vf)
      v13 = v12
      E11 = E1f * Vf + Er * (1 - Vf) + (4.0d0* (vr- v12f**2) * kf * kr * 
     & Gr * (1.0d0- Vf) * Vf) / ((kf + Gr) * kr + (kf - kr) * Gr * Vf)
      E22 = 1.0d0/((4.0d0* kt)**(-1.0d0)+(4.0d0* G23)**(-1.0d0)+
     & (v12**2.0d0/ E11))
      E33 = E22
      v23 = (2.0d0* E11 * kt-E11*E22-4.0d0* v12**2.0d0*kt*E22)/(2.0d0* 
     & E11 * kt)
      v21 = v12 * E22 / E11
      v31 = v13 * E33 / E11
      v32 = v23 * E33 / E22
...
C
      DETA = (1.0d0- V12 * V21 - V23 * V32 - V13 * V31 - 2.0d0*V21*V32 * 
     & V13) / (E11 * E22 * E33)
      DDSDDE(1,1) = (1.0d0- V23 * V32) / (E22 * E33 * DETA)
      DDSDDE(2,2) = (1.0d0- V13 * V31) / (E11 * E33 * DETA)
      DDSDDE(3,3) = (1.0d0- V12 * V21) / (E11 * E22 * DETA)
